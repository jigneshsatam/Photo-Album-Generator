...
docker compose --project-directory ../../Photo-Album-Generator/ down -v

# Run the application
docker compose --project-directory ../../Photo-Album-Generator/ up -d --scale backend=3

open http://localhost:8827/hello & wait
